...
Model Name: Haas SL30 Turret
Author: Dennis Chaves
Link: https://grabcad.com/library/haas-sl30-turret-1

Model Name: VDI 40 TOOL HOLDER BLOCK
Author: Greg Johnson
Link: https://grabcad.com/library/vdi-40-tool-holder-block-1

Model Name: Shank tools
Author: inbkbe
Link: https://grabcad.com/library/shank-tools-1

Model Name: lathe tailstock taper dimensions
Author: mustafa zorlu
Link: https://grabcad.com/library/lathe-tailstock-taper-dimensions-1

Model Name: tailstock body
Author: karthick
Link: https://grabcad.com/library/tailstock-body-1

Model Name: Chuck
Author: Michael Přecechtěl
Link: https://grabcad.com/library/chuck-35/details?folder_id=14142789

Model Name: OP320
Author: Bo cu khoai 0906600780
Link: https://grabcad.com/library/op320-1

Model Name: Siemens HMI panel for reference only
Author: Tactical Panda
Link: https://grabcad.com/library/siemens-hmi-panel-for-reference-only-1

Model Name: flexible coolant tube pipe
Author: DEEPAK CHAURASIA
Link: https://grabcad.com/library/flexible-coolant-tube-pipe-1

Model Name: lathe tool
Author: Ilie Maftean
